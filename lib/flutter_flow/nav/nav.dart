...
class AppStateNotifier extends ChangeNotifier {
  MimirFirebaseUser? initialUser;
  MimirFirebaseUser? user;
  ...
  void update(MimirFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
            ...
            FFRoute(
              ...
              builder: (context, params) => EditClassWidget(
                classes: params.getParam(
                    'classes', ParamType.DocumentReference, false, ['classes']),
              ),
            ),
            FFRoute(
              name: 'ClassDetails',
              ...
              builder: (context, params) => ClassDetailsWidget(
                clas: params.getParam(
                    'clas', ParamType.DocumentReference, false, ['classes']),
              ),
            ),
            FFRoute(
              name: 'auditLog',
              path: 'auditLog',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'auditLog')
                  : AuditLogWidget(),
            ),
            FFRoute(
              name: 'onboarding',
