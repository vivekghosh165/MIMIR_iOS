...
import 'schema/api_update_record.dart';
...
export 'schema/api_update_record.dart';
...
Future<int> queryAttendancesRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      AttendancesRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Future<FFFirestorePage<AttendancesRecord>> queryAttendancesRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
...
/// Functions to query ApiUpdateRecords (as a Stream and as a Future).
Future<int> queryApiUpdateRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ApiUpdateRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ApiUpdateRecord>> queryApiUpdateRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<ApiUpdateRecord>> queryApiUpdateRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ApiUpdateRecord>> queryApiUpdateRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
